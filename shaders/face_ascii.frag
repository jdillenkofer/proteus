...
// ASCII Face Shader
// Replaces the detected face with procedural ASCII art characters.
// Background remains as the original video feed.
...
void main() {
    ...
    f_color = mix(original_color, vec4(final_ascii, 1.0), mask);
}
